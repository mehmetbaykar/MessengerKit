...
public class InputAccessoryViewPlaceholder: UIView {
    ...
    private lazy var heightConstraint: NSLayoutConstraint = {
        ...
        heightConstraintView.topAnchor.constraint(equalTo: self.topAnchor).isActive = true
        heightConstraintView.bottomAnchor.constraint(equalTo: self.bottomAnchor).isActive = true
        
        return   heightConstraintView.heightAnchor.constraint(equalTo: self.heightAnchor)
